    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
          ...
          <ul className={styles.content}>
            <li className={styles.body}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Rialta Ediciones (Latin America)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Maria Rosales Gerpe’s Personal blog (US)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">OnCuba (Cuba)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Cuban Art Gallery (Miami)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Noticias cubanas (Miami)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Latinus (Latin America)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Tra i Leoni (Bocconi University blog – Italy, interwiew to co-founder Luisa Ausenda)</a>
            </li>
          </ul>
        </section>
            ...
            <ul>
              <li className={styles.body}>
                <a
                  ...
                  title="open press in new tab"
                  target="_blank"
                  rel="noopener noreferrer noopener noreferrer">Cuban art NFTs’ genesis (Havana-Miami)</a>
              </li>
              ...
              <li className={styles.body}>
                <a
                  ...
                  title="open press in new tab"
                  target="_blank"
                  rel="noopener noreferrer noopener noreferrer">Refinery29 (US)</a>
              </li>
              ...
              <li className={styles.body}>
                <a
                  ...
                  title="open press in new tab"
                  target="_blank"
                  rel="noopener noreferrer noopener noreferrer">Vistar magazine (Cuba)</a>
              </li>
              ...
              <li className={styles.body}>
                <a
                  ...
                  title="open press in new tab"
                  target="_blank"
                  rel="noopener noreferrer noopener noreferrer">El Nacional (Spain)</a>
              </li>
              ...
              <li className={styles.body}>
                <a
                  ...
                  title="open press in new tab"
                  target="_blank"
                  rel="noopener noreferrer noopener noreferrer">Criptolite (US and Latin America)</a>
              </li>
              ...
              <li className={styles.body}>
                <a
                  ...
                  title="open press in new tab"
                  target="_blank"
                  rel="noopener noreferrer noopener noreferrer">MOCCA (Museo del Cripto Arte Cubano – Cuba)</a>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.content}>
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Nifty Selects (US)</a>
            </li>
            <li className={styles.body}>
              <a
                className={styles.link}
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Crypto Basel 2021 (Miami Art Week MUSTSEEs)</a>
          ...
          <ul className={styles.content}>
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Spotify – it Will Work Podcasts (Interview in Italian to Luisa Ausenda)</a>
            </li>
          </ul>
          <div className={styles.content}>
          ...
          <ul className={styles.content}>
            <li className={styles.body}>
              <p>Round Table: "Collecting vs Trading in Digital Art". Bridge to Metaverse opening recaption - Webinar with Matt Hall (Larva Labs, Cryptopunks creator), Alex Salnikov (Rarible)</p>
            </li>
            <li className={styles.body}>
              <a
                className={styles.link}
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">John Crain (Superrare) and Luisa Ausenda (Gallery Continua/ClitSplash)</a>
            </li>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">“Summiting NFTs. A review of A Courma!” 2021 panel (ArtBasic – UK)</a>
              ...
              {/* * see the panel program’s at <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">https://www.acourma.org/panel-22-luglio-2021</a> */}
            </li>
            <li className={styles.body}>
              <a
                className={styles.link}
          ...
          <ul className={styles.content}>
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Part 1</a>
            ...
            <li className={styles.body}>
              <a
                ...
                title="open press in new tab"
                target="_blank"
                rel="noopener noreferrer noopener noreferrer">Part 2</a>
