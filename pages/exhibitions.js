    ...
    <>
      ...
      <section className={styles.section}>
        ...
        <figure className={styles.logoimglg}>
          <Image
            src="/static/Found_World-cover.png"
            layout="responsive"
            height={576}
            width={1024}
            alt="Erotika II logo"
        ...
        <div className={styles.content}>
          <h2 className={styles.subheading}>EROTIKA II</h2>
          ...
          <br />
          <br />
          <h3 className={styles.subheading}>Agenda</h3>
          <div className={styles.grid}>
            <div>
              ...
              <p className={styles.bodySm}>
                “Visions Outside the Mainstream” Talk with curators of EROTIKA II, ClitSplash
            </p>
              <p className={styles.bodySm}>
                <strong>18:00</strong>
              </p>
              <p className={styles.bodySm}>
                Presentation of a curated selection of Erotic Film Screenings
            </p>
              <p className={styles.bodySm}>
                <strong>19:00</strong>
              </p>
              <p className={styles.bodySm}>
                Poetry readings by Daniela Ciocca and Ana María Caballero
            </p>
              <p className={styles.bodySm}>
                Daniela Ciocca
            </p>
              ...
              <p className={styles.bodySm}>
                Daniela Ciocca will be presenting some poems that cover modern topics, but in a style that hails to a bygone, Beatnik era.
            </p>
              <strong>20:00</strong>
              <p className={styles.bodySm}>
                Conceptual Performance art piece by anonymous artist Oona
            </p>
              <p className={styles.bodySm}>
                Oona
            </p>
              ...
              <p className={styles.bodySm}>
                Hyperfeminist comedy set by Brittany Brave &amp; Satisfyer vibrator giveaways
            </p>
              <p className={styles.bodySm}>
                Brittany Brave
            </p>
              ...
              <p className={styles.bodySm}>
                Performance piece on the intimacy and polarity play of a tantric BDSM scene
            </p>
              <p className={styles.bodySm}>
                Jaqueline Michelle
            </p>
              ...
              <p className={styles.bodySm}>
                Dance Party &amp; DJ set by Soleil Bravo
            </p>
            ...
            <div>
              ...
              <p className={styles.bodySm}>
                “Rebel in Venus” book reading by Marissa Alma Nick
              </p>
              <p className={styles.bodySm}>
                Marissa Alma Nick
              </p>
          ...
          <ul className={styles.body}>
            <li>
              <a
                href="https://twitter.com/wonderkatzi"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
                Sasha Katz
              </a>
            </li>
            <li>
              <a
                href="https://twitter.com/cymoonv_eth"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/lanadenina"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/chaallka"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/0xVestica"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/Ninocence"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/olgafedorova112"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/KatieeMcIntyre"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/Harriet_Blend"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/DolcePaganne"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/RasAlhagve"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/luluixixix"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/madebyoona"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://twitter.com/DDO__xyz"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://www.instagram.com/llamameava/"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://www.instagram.com/yuliangliubln/"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
            ...
            <li>
              <a
                href="https://www.instagram.com/justynakisielewicz/"
                target="_blank"
                rel="noreferrer noopener"
                title="go to artist's twitter page"
              >
          ...
          <p className={styles.body}>
            Big thank you to our partners and sponsors <a href="https://www.3sonsbrewingco.com/">3 Sons</a>, <a href="https://www.instagram.com/cigarmancave/?hl=en">Mancave</a>, <a href="https://www.instagram.com/cliterallylube/">Cliterally Lube</a><a href="https://us.satisfyer.com/us">Satisfyer</a>, <a href="https://www.instagram.com/jiggypuzzles/?hl=en">Jiggy Puzzles</a>
          </p>
        </div>
